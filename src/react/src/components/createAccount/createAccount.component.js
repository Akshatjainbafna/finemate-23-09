...
class createAccount extends Component {
    ...
    submit(e) {
        ...
        axios.post('http://localhost:8103/api/db_create_user', {user_type:this.state.user_type, email: this.state.email,username:this.state.username, password: this.state.password })
            .then(response => {
