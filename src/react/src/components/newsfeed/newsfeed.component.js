...
import $ from 'jquery';
import { BsArrowLeft, BsArrowLeftRight, BsArrowRight, BsArrowRightShort, BsBookmarkHeart, BsBookmarkHeartFill, BsFillXCircleFill, BsHeart, BsHeartFill, BsLightbulb, BsLightbulbFill, BsThreeDotsVertical } from 'react-icons/bs'
...
function PreviousNextWindow(props) {
    ...
    function fetchPreviousPost() {
        ...
        try {
            AxiosBaseFile.get('/api/db_get_particular_post', {
                params: {
        ...
        return (
            <>
                {this.state.responseData.map((responseData, index) =>
                    <div id={"post" + String(index)} className={style.postTypeDecider} key={index}>
                        {(() => {
                                ...
                                return <div className={style.postCardContainer} key={index} onMouseLeave={() => { document.getElementById('postCredits' + index).style.display = 'none'; this.setState({ dropDown: false }) }}>
                                    ...
                                    <form id="postInteraction">
                                        ...
                                        <div className={style.postImg} onDoubleClick={() => { this.postLiked(index) }} id="imageLocation">
                                            ...
                                            <img id={"backgroundImage" + String(index)} src={require('../../assets/postBackgroundImages/' + responseData.background)} className={style.backgroundImage} alt='post' onClick={(e) => this.openImageWindow(e.target)} />
