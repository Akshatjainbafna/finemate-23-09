...
import { BsArrowLeft, BsArrowRight, BsArrowRightShort, BsPlus, BsThreeDotsVertical, BsXCircle, BsXCircleFill } from 'react-icons/bs'
                        ...
                        <div className={style.postCardContainerIndividual} key={index} onMouseLeave={() => { this.hideMoreOptions(); this.hidePreviousNextPostWindow() }}>
                            ...
                            <form id="postInteraction">
                                ...
                                <div className={style.postImg} onDoubleClick={() => this.postLiked()} id="imageLocation">
                                    ...
                                    <img id={responseData.background} src={require('../../assets/postBackgroundImages/' + responseData.background)} className={style.backgroundImage} onClick={(e) => this.openImageWindow(e.target)} />
