...
import { Button, Checkbox, Dialog, DialogActions, DialogContent, DialogTitle, Divider, FormControlLabel, InputLabel, OutlinedInput, Radio, RadioGroup, Snackbar, Tooltip, useMediaQuery, useTheme } from '@material-ui/core';
import { BsPatchPlus, BsPlusSquare, BsToggle2Off, BsToggle2On } from 'react-icons/bs';
    ...
    return (
        <>
            ...
            >
                ...
                <DialogActions>
                    <Button style={{ color: 'var(--purpleMain)' }} onClick={() => setTodoState(false)}>
                        Cancel
                    </Button>
                    <Button style={{ backgroundColor: 'var(--purpleMain)', color: '#ffffff' }} type="submit" onClick={() => onSubmitHandler()}>
                        Add Todo
                    </Button>
                </DialogActions>
            </Dialog>
            ...
            <>
                ...
                <a href="">Earliest Todo's</a>
                    ...
                    <div className={style.todoIcons}>
                        <div onClick={this.addTodoWindow}>
                            Add To-Do
                        </div>
                        <div onClick={this.switchTodoList}>
                            Change View
                        </div>
                    </div>
