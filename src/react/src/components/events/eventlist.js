        ...
        return (
            <div>
                ...
                { this.state.courses.map(courses =>
                    <Card className='courseCards'  bg="light" text="black" style={{ height:'17rem', width: '19rem' }} name='course_name' value={courses.dashevent_name}>
                        <Card.Header className='eventHeader' style={{height:'14rem', color:'white',background:'black' } }></Card.Header>
                        <div class="numberCircle" ></div>
                        <div class="titleCircle">{courses.dashevent_name}</div>
                        <Card.Body style={{height:'10rem', width:  '19rem', color:'white'} }>
