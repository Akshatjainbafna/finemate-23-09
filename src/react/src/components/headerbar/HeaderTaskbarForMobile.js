          ...
          <Button onClick={this.toggleDrawer(true)}>
              <div>
                {localStorage.getItem('profilePicture') != 'null' ?
                  <img src={require('../../assets/profilePictures/' + localStorage.getItem('profilePicture'))} style={{width: '32px', borderRadius: '100%'}} />
                  :
                  <img src={generator.generateRandomAvatar(localStorage.getItem('name'))} style={{width: '32px'}} />
                }
              </div>
          </Button>
          <Button>
              ...
              <div className="d-flex align-items-center">
                <span className={style.mobileSideBarProfilePic}>
                  {this.state.profilePicture != 'null' ?
                    ...
                    :
                    <ListItemAvatar>
                      <img src={generator.generateRandomAvatar(localStorage.getItem('name'))} className={style.profilePictureSidebarThumbnail} />
                    </ListItemAvatar>
                  }
                </span>
                <span><b>{localStorage.getItem('name')}</b></span></div>
            </Link>
            <p> </p>
            <Divider />
            <List>
