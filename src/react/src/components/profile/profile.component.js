              ...
              <div className="rightBlockofInfoCard">
                ...
                {this.state.displaying ?
                  <div className="d-flex justify-content-center align-items-center mt-2">
                    <button className="edit_button_profile brightness-low-btn" type="button" onClick={() => { this.setState({ displaying: false }) }}>
                      Edit Profile
                    </button>
                  </div>
                  :
                  <div className="d-flex justify-content-around align-items-center mt-2">
                    <button
                      className="cancel_button brightness-low-btn"
                      type="button"
                    ...
                    <button
                      className="save_button brightness-low-btn"
                      form="my-form"
                      type="submit"
                      onClick={() => { }}
                    >
