...
let headerItems = { link: "/profile", title: "Fee Section", profileImg: profile };
...
class FeesPaymentSystem extends React.Component{
    render() {
...
export default FeesPaymentSystem