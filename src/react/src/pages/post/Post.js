...
import IndividualPost from "../../components/newsfeed/post.component";


let headerItems = { link: "/profile", title: "Post", profileImg: profile };
...
class IndividualPostPage extends React.Component{
    render() {
              ...
              <>
                <HeaderBarForMobile className="headerForMobile" books={navItemsMobileForNormalUser} />
                  <div className="todoPageMobile">
                    <IndividualPost id = {this.props.match.params.id} />
                  </div>
